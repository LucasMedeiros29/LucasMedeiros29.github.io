#!/usr/bin/env python3
'''
Este script é utilizado para realizar a calibração da câmera com conceitos vistos em aula nos laboratórios.
a biblioteca utilizada é o OpenCV (pip install opencv-python) e também o numpy (pip install numpy)
