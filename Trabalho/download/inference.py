...
try:
    ...
    print(f"Nomes de classes carregadas: {classes}")
except FileNotFoundError:
    print("'models/class_names.pkl' não encontrado. Usando nomes de classes padrão.")
...
if not cap.isOpened():
    print("Erro: Não foi possivel abrir a webcam.")
    exit()
...
while True:
    ...
    cv2.imshow("Pixel Rangers", frame)
