...
cap1 = cv.VideoCapture(2)  # Webcam esquerda
cap2 = cv.VideoCapture(0)  # Webcam direita
...
out_left = cv.VideoWriter('output__sift.mp4', fourcc, fps, (frame_width, frame_height))
